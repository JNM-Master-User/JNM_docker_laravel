...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('partners',[AdminController::class,'renderPartners'])
            ->name('partners');

        Route::get('institutions',[AdminController::class,'renderInstitutions'])
            ->name('institutions');

        Route::post('partners',[AdminController::class,'storePartners']);
    });
});

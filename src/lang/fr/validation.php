...
return [
    ...
    */
    ...
    'uploaded' => 'Le télechargement due champ :attribute a échoué.',
    ...
    */
    ...
    'custom' => [
        'user-status' => [
            'banned-combination' => 'Vous ne pouvez pas avoir les status :attribute, :other en même temps.',
            'required-combination' => 'Vous devez avoir le status :attribute si vous souhaitez avoir le status :other',
            'not-admin' => 'Droits insuffisant, vous ne pouvez pas être administrateur'
        ],
        'object' => [
            'duplicate' => ':attribute : :value existe déjà, veuillez modifier les informations renseignées ou modifier l\'élément en question dans la liste ci-dessous.'
    ...
    */
    ...
    'attributes' => [
        ...
        'Allotments' => 'Logements',
        'Allotment' => 'Logement',
        'allotment_name' => 'Nom Logement',
        'allotment_address' => 'Adresse Logement',
        'allotment_zip_code' => 'Code Postal Logement',
        ...
        'Users Status' => 'Status Utilisateurs',
        'User Status' => 'Status Utilisateur',

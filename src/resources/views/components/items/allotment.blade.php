<div>
    <form method="POST" action="{{ route('allotments.update') }}">
        <table class="table-fixed  divide-gray-200">
            <tbody class="bg-white  divide-gray-200 dark:divide-gray-500">
            <tr class="hover:bg-gray-100">
                @csrf
                <td class="p-2 w-48 flex items-center whitespace-nowrap space-x-6 mr-2">
                ...
                <td class="p-2 w-48 whitespace-nowrap font-medium text-gray-900">
                ...
                <td class="p-2 w-48 whitespace-nowrap space-x-2">
                ...
                <td class="p-2 w-48 whitespace-nowrap space-x-2">
                    ...
                    <script type="text/javascript">
                        document.getElementById('buttonEditAllotment-{{$allotment->id}}').addEventListener('click', () => {
                            ...
                            document.getElementById('allotment-zipcode-{{$allotment->id}}').innerHTML = `<input name="allotment_zip_code" value='{{$allotment->zip_code}}'  />`;
                        });
                    </script>
                </td>
                <td class="p-2 w-48 whitespace-nowrap space-x-2">

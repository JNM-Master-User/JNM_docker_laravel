<tr class="hover:bg-gray-100">
    ...
    <td class="p-2 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
        ...
        <div class="text-sm font-normal text-gray-500">
            <div class="text-sm font-normal text-gray-500">{{$partner->name}}</div>
        </div>
    </td>
    <td class="p-2 whitespace-nowrap text-base font-medium text-gray-900">
        <div class="text-sm font-normal text-gray-500">{{$partner->company}}</div>
    </td>

    <td class="p-2 whitespace-nowrap text-base font-medium text-gray-900">
        <div class="text-sm font-normal text-gray-500">{{$partner->path_picture}}</div>
    </td>
    <td class="p-2 whitespace-nowrap space-x-2">
        <button type="button" data-modal-toggle="user-modal-{{$partner->id}}" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">

<tr class="hover:bg-gray-100">
    ...
    <td class="p-2 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
        <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name={{$institution->name}}" alt="Michael Gough avatar">
        <div class="text-sm font-normal text-gray-500">
            <div class="text-sm font-normal text-gray-500">{{$institution->name}}</div>
        </div>
    </td>
    ...
    <td class="p-2 whitespace-nowrap text-base font-medium text-gray-900">
        <div class="text-sm font-normal text-gray-500">{{$institution->path_picture}}</div>
    </td>
    <td class="p-2 whitespace-nowrap text-base font-medium text-gray-900">
        @if($institution->desc != null)
            <div class="text-sm font-normal text-gray-500">{{$institution->desc}}</div>
        @else

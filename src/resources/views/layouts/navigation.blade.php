        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <form action="#" method="GET" class="hidden lg:block lg:pl-32">
                    ...
                    <div class="mt-1 relative lg:w-64">
                        ...
                        <input type="text" name="email" id="topbar-search" class="text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 block w-full pl-10 p-2" placeholder="Search">
                    </div>
                </form>
            </div>
            <div class="flex items-center">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <x-buttons.form-button name="{{ __('Log Out') }}"></x-buttons.form-button>
                </form>
            </div>
        </div>
    </div>
